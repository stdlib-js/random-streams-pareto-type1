...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a Pareto (Type I) distribution', function test( t ) {
	var iStream;
	var result;
	var rand;
	var opts;
...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a Pareto (Type I) distribution (object mode)', function test( t ) {
	var iStream;
	var count;
	var rand;
	var opts;
